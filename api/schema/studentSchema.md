 ...
 * DATABASE SCHEMA
 * ===============
 * Two separate collections for auth separation:
 * 
 * 1. users collection - Authentication only
 * 2. students collection - Student profiles only
 * 
 * Link via email field
 */
...
const studentDocument = {
  ...
  application: {
    ...
    target_programme: "BSC COMPUTER SCI CST",   // From 45 real programmes
  ...
  personal: {
    name: "String",
    email: "String",           // Links to users collection
  ...
  academic: {
    institution: "CUHK - CUHK, The Chinese University of Hong Kong",  // From 60+ HK institutions
    raw_cgpa: 3.6,
    max_cgpa: 4.0,
